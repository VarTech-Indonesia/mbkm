    ...
    <table class="table table-head-fixed text-nowrap">
        <thead>
            <tr>
                ...
                <div class="btn-group btn-group-sm align-center">
                    <a href="{{ route('menu-two-child.create') }}" class="btn btn-success">Add</a>
                </div>
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>{{$item->menuParent->title}}</td>
                <td>{{$item->menuOneChild->title}}</td>
                <td>{{$item->title}}</td>
                <td>{{$item->link}}</td>
                <td>{{$item->status}}</td>
                <td>
                <div class="btn-group btn-group-sm">
                <a href="{{ route('menu-two-child.edit', $item->id) }}" class="btn btn-warning">Edit</a>
                </div>
                </td>
            </tr>
            @empty
