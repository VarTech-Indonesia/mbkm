...
<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="{{ asset('storage/images/100th-ITB.png') }}" alt="img" class="footer_logo" />
            </div>
            ...
            <div class="col-12 col-md-12 col-lg-4 ">
                ...
                <a href="{{ $item->link }}" class="footer_img_post_6"><img src="{{ asset('storage/'.$item->image) }}" alt="{{ $item->excerpt  }}" /></a>
                @endforeach
            </div>
        </div>
    </div>
...
<div class="container-fluid fh5co_footer_right_reserved">
    <div class="container">
        <div class="row  ">
            <div class="col-12 col-md-1 py-4 Reserved"> <img src="{{ asset('storage/images/itb-white.png') }}" alt="ITB"> <a
