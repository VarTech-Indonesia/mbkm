        ...
        <div class="row mx-0 contentna">
            <div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                ...
                <p>
                        ...
                        negeri_fin_-_medres-4jan_par"><button type="button"
                                class="btn btn-info">https://issuu.com/lppmitb/docs/bakti_kami_di_pelosok_
                                negeri_fin_-_medres-4jan_par</button></a>

            </div>
            <div class="col-md-6 animate-box m-auto" data-animate-effect="fadeInRight">
                <img src="{{ asset('images/brand-desabinaan.png') }}" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</div>
